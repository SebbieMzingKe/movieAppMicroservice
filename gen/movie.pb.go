...
const file_movie_proto_rawDesc = "" +
	...
	"recordType\x12!\n" +
	"\frecord_value\x18\x04 \x01(\x05R\vrecordValue\"\x13\n" +
...
var file_movie_proto_goTypes = []any{
	...
	(*PutMetadataRequest)(nil),          // 2: PutMetadataRequest
	(*PutMetadataResponse)(nil),         // 3: PutMetadataResponse
...
var file_movie_proto_depIdxs = []int32{
	...
	4,  // 4: MetadataService.GetMetadata:input_type -> GetMetadataRequest
	2,  // 5: MetadataService.PutMetadata:input_type -> PutMetadataRequest
	...
	3,  // 10: MetadataService.PutMetadata:output_type -> PutMetadataResponse
